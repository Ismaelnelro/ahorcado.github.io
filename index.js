...
var hang_man = ["soga", "cabeza,mandibula,oreja1,oreja2", "cuerpo", "hombro1,antebrazo1,mano1", "hombro2,antebrazo2,mano2", "arma", "pelvis,muslo1,canilla1,pie1", "muslo2,canilla2,pie2"]
mostrar_hangman = () => {
    if (hang_man.length != 0) {

        let mostrar = hang_man[0].split(",")
        for (let i = 0; i < mostrar.length; i++) {
            let $hang = document.getElementById(`${mostrar[i]}`);
            $hang.className = ""
        }
        hang_man.shift();
